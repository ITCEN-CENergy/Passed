      ...
      <main className="main-content">
        ...
        <section className="section-card">
          <h2 className="section-title">
            ...
            <div className="relevance-header-stats">
              <span className="stat-item reflected"><CheckCircle2 size={14} /> 반영 2</span>
              ...
              <span className="stat-item needs-check"><HelpCircle size={14} /> 확인 필요 1</span>
            </div>
          </h2>
          ...
          <div className="relevance-list">
            <div className="relevance-list-item">
              <div className="relevance-item-left">
                <CheckCircle2 size={16} className="reflected" /> 대용량 트래픽 처리
              </div>
              <div className="relevance-item-right reflected">
                반영 <ChevronDown size={16} color="var(--text-muted)" />
              </div>
            </div>
            <div className="relevance-list-item">
              <div className="relevance-item-left">
              ...
              <div className="relevance-item-right partial">
                부분 반영 <ChevronDown size={16} color="var(--text-muted)" />
              </div>
            </div>
            <div className="relevance-list-item">
              <div className="relevance-item-left">
                <HelpCircle size={16} className="needs-check" /> 카카오 서비스 이해
              </div>
              <div className="relevance-item-right needs-check">
                확인 필요 <ChevronDown size={16} color="var(--text-muted)" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-card">
          ...
          <div className="edit-comparison">
            ...
            <div className="edit-box">
              ...
              <div className="edit-badge"><CheckCircle2 size={12} /> 반영됨</div>
              <br/>
          ...
          <div className="collapsible-item">
            2. 문장 검토 중 <ChevronDown size={16} />
          </div>
          <div className="collapsible-item" style={{ borderBottom: 'none' }}>
            3. 문장 검토 대기 <ChevronDown size={16} />
          </div>
        </section>
        ...
        <section className="section-card">
          ...
          <div className="info-notice">
            <Lock size={12} /> 확인되지 않은 사실은 임의로 작성하지 않아요.
          </div>
        </section>
